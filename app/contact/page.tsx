...
return (
  <section className=" py-20 lg:py-[120px] overflow-hidden relative z-1">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <div className="mb-1 text-xl font-bold text-dark">
                      Our Location
                    </div>
                    <p className="text-base text-body-color">
                    3, 19th main, 27th Main Rd, opposite Nagarjuna appartment, 2nd Sector, HSR Layout
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
